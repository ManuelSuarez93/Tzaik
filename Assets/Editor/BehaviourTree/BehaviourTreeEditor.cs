...
namespace BehaviourTree
{
    public class BehaviourTreeEditor : EditorWindow
    {
        ...
        [OnOpenAsset]
        public static bool OnOpenAsset(int insinstanceID, int line)
        {
        ...
        public void CreateGUI()
        {
            ...
            blackboard = root.Q<IMGUIContainer>();
            blackboard.onGUIHandler = () =>
            {
                ...
                {
                    Debug.LogWarning("No Behaviour tree selected");
                }
            };
